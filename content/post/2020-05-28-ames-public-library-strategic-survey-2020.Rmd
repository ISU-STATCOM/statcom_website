...
author: Chancellor Johnston, Charlotte Roiger, Yuchen Wang, Miranda Tilton, Amin Shirazi
date: '2020-05-28'
...
In this survey, multiple age categories were marked off in order to get more information about the preferences being represented in the survey. More than half of responses indicated the 60+ age group, so their results drive the rest of the survey. The most dissimilar group is the under age 11 group, so we provided them as a contrast to the overall results. However, they are not very different, in part because all the programs were broadly popular and possibly because adults were filling the surveys out and represented their own interests as well. 
